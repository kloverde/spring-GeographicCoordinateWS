...
Each of the SOAP operations have a REST version which return JSON.  A high-level summary is provided below.  See the `WsRestController` javadoc for more detail.
