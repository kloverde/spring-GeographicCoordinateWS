...
Anyway, each of the SOAP operations have a RESTish version:  distance, initial bearing and back azimuth calculations are all available via `GET`.  All responses are in JSON.
